...
foreach($products as $_product): 
  ...
  <?php if(!$isMobile && !$isIOS) :?>
    <div class="card list-product">
      <a href="<?php echo !empty( $product->getCheapestVariantID() )?get_permalink( $product->get_id() ) . '?varid=' . $product->getCheapestVariantID():get_permalink( $product->get_id() ); ?>" class="imageContainer">
        <?php echo $_product->get_image( 'woocommerce_random_services', [ 'class' => 'service-image card-img-top', 'alt'=>$product->get_name() ] ); ?>
      </a>
      <div class="card-body">
