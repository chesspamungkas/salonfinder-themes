				...
				<div class="author-block">
					<div class="author-intro">
						<div class="author-image-block">
							...
							<img src="<?php echo wp_get_attachment_image_url( get_the_author_meta( 'image' ) ) ?>"
							     alt=""
		...
		<div class="container p-t-15 p-b-15">
			<div class="author-block posts-grid">
				<div class="author-posts"> 
					...
					//echo "<pre>";print_r($author_posts);echo "</pre>";
//echo $total_post;
					...
					<div class="flex-grid">
						<?php 
							...
							<div class="flex-grid-item">
								<div class="img">
                                <a href="<?php the_permalink(); ?>"><img src="<?php echo get_the_post_thumbnail_url( get_the_ID() ) ?>"
                                                                                      alt="<?php the_title(); ?>"></a>
								</div>
